...
class ViewDataUser extends StatefulWidget {
  const ViewDataUser({Key? key, required this.document, required this.id, required this.wid})
      : super(key: key);
  ...
  @override
  State<ViewDataUser> createState() => _ViewDataUserState();
}
...
class _ViewDataUserState extends State<ViewDataUser> {
  ...
  void initState() {
    ...
    _category = category;
    bool ischecked=widget.document["ischecked"];
                  ...
                  Row(
                    children: [
                      ...
                      IconButton(
                        ...
                        icon: Icon(
                          _ischecked==true?Icons.check_box:Icons.check_box_outline_blank,

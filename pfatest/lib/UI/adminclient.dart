...
class adminclientinfo extends StatefulWidget {
  const adminclientinfo({Key? key}) : super(key: key);

  @override
  State<adminclientinfo> createState() => _adminclientinfoState();
}

class _adminclientinfoState extends State<adminclientinfo> {

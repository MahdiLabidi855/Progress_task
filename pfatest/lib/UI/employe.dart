...
import 'package:pfatest/UI/employeinfo.dart';
...
class _EmployeState extends State<Employe> {
  ...
  Widget build(BuildContext context) {
    final List = <Widget>[privet?const client():const todohome(),const employeinfo(), const settings()];
